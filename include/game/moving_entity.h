...
public:
    MovingEntity(): m_Velocity(Vector()), m_Heading(Vector()), m_Side(Vector()),
        m_MaxSpeed(0.0), m_MaxForce(0.0), m_MaxTurnRate(0.0) {}

    MovingEntity(Vector _pos, double _radius, Vector _velocity, Vector _heading,
        double max_speed, double max_force, double turn_rate): Entity(_pos, _radius), m_Velocity(_velocity),
        m_Heading(_heading), m_Side(_heading.Perp()), m_MaxSpeed(max_speed), m_MaxForce(max_force), m_MaxTurnRate(turn_rate) {}
